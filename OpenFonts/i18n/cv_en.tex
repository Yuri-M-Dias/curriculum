...
\def \educationMSDuration{Mar 2018 - Mar 2021 |\newline São José dos Campos, BR}
...
\def \educationBSDuration{Dec 2016 | Goiânia, BR}
...
\def \researchMSDur{Mar 2018 – Mar 2021 | São José dos Campos, BR}
\def \researchMSDesc{
Worked on Data Analysis tools and algorithms to support spacecraft operators at the Satellite Control Center (CCS), doing research on Big Data for Satellite Operations.
